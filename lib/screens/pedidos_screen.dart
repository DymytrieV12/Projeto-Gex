...
class _PedidosScreenState extends State<PedidosScreen> {
  ...
  String _currency(double value) =>
      'R\$ ${value < 0 ? '-' : ''}${value.abs().toStringAsFixed(2)}';
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (item.valorDescontoUnitario > 0) ...[
                                      ...
                                      Text(
                                        'Preço com desconto: ${_currency(item.valorUnitario - item.valorDescontoUnitario)}/un',
                                        style: const TextStyle(
                                          color: Color(0xFF0E5A35),
                                          fontSize: 12,
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: const LinearGradient(
                            ...
                            colors: [Color(0xFFF6FFF9), Color(0xFFEAF7EE)],
                          ),
                          borderRadius: BorderRadius.circular(16),
                          border: Border.all(
                            color: const Color(0xFF0E5A35).withValues(alpha: 0.12),
                          ),
                        ),
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(
                              pedido.temPix
                                  ? 'QR Code, código copia e cola e boleto disponíveis.'
                                  : 'Boleto disponível para download e cópia.',
                              style: TextStyle(
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton.icon(
                                onPressed: () => showPagamentoSheet(context, pedido),
                    ...
                    _totalRow(
                      'Valor dos produtos',
                      pedido.valorPedido > 0 ? pedido.valorPedido : pedido.valorTotal,
                    ),
                    if (pedido.valorFrete > 0) _totalRow('Frete', pedido.valorFrete),
